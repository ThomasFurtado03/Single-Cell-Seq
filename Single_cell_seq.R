...
#Cluster 5 has quite a lot of variation across the studied time periods. I will choose to investiate this cluster.

#What genes in Cluster 5 change between early and late infection?
#================================================================


#Lets subset Cluster 5
...
#Finding differentially expressed genes between the two time frames.
